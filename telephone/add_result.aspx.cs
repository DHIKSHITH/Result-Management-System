    ...
    public partial class add_result : System.Web.UI.Page
    {
        ...
        protected void b1_Click(object sender, EventArgs e)
        {
           
            {
                ...
                cmd.CommandText = "insert into add_result values('" + Session["username"].ToString() + "','" + firstname.Text + "','" + usn.Text + "','" + sub1.Text + "','" + sub2.Text + "','" + sub3.Text + "','" + sub4.Text + "','" + sub5.Text + "','" + sub6.Text + "','" + sub7.Text + "','" + sub8.Text + "','" + total.Text + "','" + percentage.Text + "')";
                cmd.ExecuteNonQuery();
